...
document.addEventListener("DOMContentLoaded", () => {
    ...
    // Load saved reviews from localStorage (unique key for Salaar)
    const savedReviews = JSON.parse(localStorage.getItem("salaarReviews")) || [];
...
function addReview() {
    ...
    localStorage.setItem("salaarReviews", JSON.stringify(savedReviews));
...
function appendReview(username, review, rating) {
    ...
    document.getElementById("salaarReviewsList").appendChild(reviewDiv);
}

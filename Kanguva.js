...
document.addEventListener("DOMContentLoaded", () => {
    ...
    // Load saved reviews from localStorage (unique key for Kanguva)
    const savedReviews = JSON.parse(localStorage.getItem("kanguvaReviews")) || [];
...
function addReview() {
    ...
    localStorage.setItem("kanguvaReviews", JSON.stringify(savedReviews));
...
function appendReview(username, review, rating) {
    ...
    document.getElementById("kanguvaReviewsList").appendChild(reviewDiv);
}

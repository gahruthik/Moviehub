...
document.addEventListener("DOMContentLoaded", () => {
    ...
    // Load saved reviews from localStorage (unique key for Saaho)
    const savedReviews = JSON.parse(localStorage.getItem("saahoReviews")) || [];
...
function addReview() {
    ...
    localStorage.setItem("saahoReviews", JSON.stringify(savedReviews));
...
function appendReview(username, review, rating) {
    ...
    document.getElementById("saahoReviewsList").appendChild(reviewDiv);
}

...
document.addEventListener("DOMContentLoaded", () => {
    ...
    // Load saved reviews from localStorage (unique key for KGF)
    const savedReviews = JSON.parse(localStorage.getItem("kgfReviews")) || [];
...
function addReview() {
    ...
    localStorage.setItem("kgfReviews", JSON.stringify(savedReviews));
...
function appendReview(username, review, rating) {
    ...
    document.getElementById("kgfReviewsList").appendChild(reviewDiv);
}

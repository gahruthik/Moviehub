...
document.addEventListener("DOMContentLoaded", () => {
    ...
    // Load saved reviews from localStorage (unique key for HHVM)
    const savedReviews = JSON.parse(localStorage.getItem("hhvmReviews")) || [];
...
function addReview() {
    ...
    localStorage.setItem("hhvmReviews", JSON.stringify(savedReviews));
...
function appendReview(username, review, rating) {
    ...
    document.getElementById("hhvmReviewsList").appendChild(reviewDiv);
}

...
document.addEventListener("DOMContentLoaded", () => {
    ...
    // Load saved reviews from localStorage (unique key for Lokah)
    const savedReviews = JSON.parse(localStorage.getItem("lokahReviews")) || [];
...
function addReview() {
    ...
    localStorage.setItem("lokahReviews", JSON.stringify(savedReviews));
...
function appendReview(username, review, rating) {
    ...
    document.getElementById("lokahReviewsList").appendChild(reviewDiv);
}

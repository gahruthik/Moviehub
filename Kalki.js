...
document.addEventListener("DOMContentLoaded", () => {
    ...
    // Load saved reviews from localStorage (unique key for Kalki)
    const savedReviews = JSON.parse(localStorage.getItem("kalkiReviews")) || [];
...
function addReview() {
    ...
    localStorage.setItem("kalkiReviews", JSON.stringify(savedReviews));
...
function appendReview(username, review, rating) {
    ...
    document.getElementById("kalkiReviewsList").appendChild(reviewDiv);
}

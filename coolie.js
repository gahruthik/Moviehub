...
document.addEventListener("DOMContentLoaded", () => {
    ...
    // Load saved reviews from localStorage (unique key for Coolie)
    const savedReviews = JSON.parse(localStorage.getItem("coolieReviews")) || [];
...
function addReview() {
    ...
    localStorage.setItem("coolieReviews", JSON.stringify(savedReviews));

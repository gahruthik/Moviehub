...
document.addEventListener("DOMContentLoaded", () => {
    ...
    // Load saved reviews from localStorage (unique key for Jawan)
    const savedReviews = JSON.parse(localStorage.getItem("jawanReviews")) || [];
...
function addReview() {
    ...
    localStorage.setItem("jawanReviews", JSON.stringify(savedReviews));
...
function appendReview(username, review, rating) {
    ...
    document.getElementById("jawanReviewsList").appendChild(reviewDiv);
}
